...
function showResults(quizID) {
    ...
    if (activeQuiz.checkAnswers()) {
        var quizScorePercent = activeQuiz.result.scorePercentFormatted;
        // The unformatted percentage is a decimal in range 0 - 1
...
//        quizElement.insertBefore(quizResultElement, quizElement.children[1]);
        ...
        quizResultElement.style.display = 'inline-flex';
